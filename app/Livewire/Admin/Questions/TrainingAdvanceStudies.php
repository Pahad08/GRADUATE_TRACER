...
class TrainingAdvanceStudies extends Component
{

    public $labels;

    //toggle visibilty of the question
    public function setLabelVisibility(string $key): void
    {
        if (!Auth::check()) {
            abort(403);
        }
        ...
        QuestionVisibility::updateOrCreate(
            ['question_key' => $key],
            [
                'section_name' => 'TRAININGS_STUDIES',
    ...
    public function loadLabels()
    {
        ...
        $defaultFields = [
            'TS-trainings' => ['label' => 'Trainings and advance studies', 'question_order' => 1],
            'TS-reason_for_studies' => ['label' => 'Reason for pursuing studies', 'question_order' => 2]
        ];
        ...
        $questions = QuestionVisibility::where('section_name', 'TRAININGS_STUDIES')->get();
    ...
    public function render()
    {
        ...
        return view('livewire.admin.questions.training-advance-studies');
    }
}
