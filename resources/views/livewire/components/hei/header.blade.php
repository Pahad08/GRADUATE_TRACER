<div data-theme="dracula" class="shadow-screen z-99 sticky top-0 w-full p-0">
    <div class="bg-primary flex w-full items-center gap-4 p-3">
        ...
        <div>
            <span class="text-primary-content hidden text-sm font-semibold md:inline">COMMISSION ON HIGHER EDUCATION
                REGIONAL
                OFFICE XII</span><br class="hidden md:inline">
            <span class="text-primary-content text-sm font-semibold">CHED XII Graduate Tracer</span>
        </div>
    </div>
    ...
    <div class="modal" role="dialog">
        <div class="modal-box">
            ...
            <div class="modal-action mt-0">
                <label wire:loading.attr="disabled" for="logout_modal" class="btn btn-soft">Close</label>
